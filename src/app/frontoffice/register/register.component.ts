...
export class RegisterComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    // ✅ SUPPRIMÉ: Ne pas rediriger automatiquement - laisser l'utilisateur voir la page register
    // pour qu'il puisse se déconnecter et se reconnecter en tant qu'admin
  ...
  onSubmit(): void {
    ...
    // Save user data locally for login
    const userData = {
    ...
    console.log("Saving user registration locally:", userData);

    // Save to localStorage with a special key to recognize signup users
    localStorage.setItem(
      `signup_user_${userData.email}`,
  ...
  private redirectByRole(): void {
    if (this.authService.isAdmin()) {
      ...
      // Non-admin users go to content list
