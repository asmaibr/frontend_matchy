...
// src/app/core/google-callback/google-callback.component.ts
var GoogleCallbackComponent = class _GoogleCallbackComponent {
  ...
  static {
    this.\u0275fac = function GoogleCallbackComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _GoogleCallbackComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(AuthService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GoogleCallbackComponent, selectors: [["app-google-callback"]], decls: 2, vars: 0, consts: [[2, "color", "white", "text-align", "center", "margin-top", "40vh", "font-size", "20px"]], template: function GoogleCallbackComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GoogleCallbackComponent, { className: "GoogleCallbackComponent", filePath: "app\\core\\google-callback\\google-callback.component.ts", lineNumber: 9 });
})();
...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-YRH7TU5G.js").then((m) => m.FrontofficeModule)
  },
  {
    path: "backoffice",
    loadChildren: () => import("./chunk-G4IOBHJZ.js").then((m) => m.BackofficeModule)
  },
  {
    path: "client",
    loadChildren: () => import("./chunk-ZRPIF5HY.js").then((m) => m.ClientModule)
  },
  {
    path: "freelancer",
    loadChildren: () => import("./chunk-6UT7BSPY.js").then((m) => m.FreelancerModule)
  },
  {
